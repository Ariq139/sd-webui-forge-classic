...
def update_token_counter(text, steps, styles, *, is_positive=True):
    ...
    prompts = ["".join(texts for texts, _ in parse_prompt_attention(prompt)) for _, prompt in flat_prompts]
                        ...
                        with FormRow():
                            ...
                            if opts.dimensions_and_batch_together:
                                with gr.Column(elem_id="txt2img_column_batch"):
                                    batch_count = gr.Slider(minimum=0, maximum=128, step=1, label="Batch Count", info="0 = infinite", value=1, elem_id="txt2img_batch_count")
                        ...
                        with FormRow():
                            ...
                            if opts.dimensions_and_batch_together:
                                with gr.Column(elem_id="img2img_column_batch"):
                                    batch_count = gr.Slider(minimum=0, maximum=128, step=1, label="Batch Count", info="0 = infinite", value=1, elem_id="img2img_batch_count")
