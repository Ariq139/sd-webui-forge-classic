...
parser.add_argument("--mmgp-attention", choices=["automatic", "sdpa", "ck", "sage", "sage2", "sage3", "flash", "flash3", "radial", "xformers"], default="automatic", help="Attention backend used by the optional MMGP path; automatic uses the normal Forge priority")
